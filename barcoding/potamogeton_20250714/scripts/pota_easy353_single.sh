...
git clone https://github.com/plant720/Easy353.git $HOME/apps/env/$env_name/bin/Easy353
cd $HOME/apps/env/$env_name/bin/Easy353
python3 setup.py install --user
}

function install_trimal { 

mkdir $HOME/apps/env/$env_name/bin/trimal
git clone https://github.com/inab/trimal.git $HOME/apps/env/$env_name/bin/trimal
...
install_basic
install_tree
pip_install #run in activated env
install_easy353
...
prefix=potamogeton
####
easy353path=$HOME/apps/env/$env_name/bin/Easy353 #this way you don't need to config in .bashrc and thus contain all the packages/path within the env
...
ref=$PARENT/353_ref_Potamogeton
#subdirectories
...
#USAGES
#=============================================
#make work directories (when writing up a complete script, include this part. otherwise it's easier to do manually)
...
#cd - #go back...
#./rename_files.py rename_fasta_easy353 -i $RESULT7 -o $RESULT7 #just get new gene names for array
...
#run_astral $RESULT12 $RESULT13 10 #get at least 6 genes for each mono taxa
}
