...
REF=$WORKDIR/ref
NAME=/mnt/shared/projects/rbge/pholling/barcoding/salix_combined/results/00_reads/sample_sp.csv #SAMPLE BAM & CORRESPONDING SPECIES
...
extract_loci $RESULT2/CIN/Scin.flt2.recode.vcf $RESULT2/CIN $NAME $high $low
